      ...
      <div className="">
        ...
        >
          <Tab
            ...
            className=""
            title={
              <div className=" px-[5px] flex items-center justify-start space-x-2 text-left">
          ...
          <Tab
            ...
            className=""
            title={
              <div className="px-[5px] flex items-center justify-center space-x-2">
