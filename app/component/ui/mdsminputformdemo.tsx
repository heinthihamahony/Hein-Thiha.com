...
export function MdSmInputFormDemo() {
  ...
  return (
    <div className="mt-20 mx-auto items-center gap-40">
      ...
      <div className="max-w-md w-full mx-auto mt-12 rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-[#282730] dark:bg-black ">
